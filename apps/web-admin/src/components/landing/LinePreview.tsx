...
export default function LinePreview() {
  return (
    <div className="relative mx-auto w-[280px] rounded-[2.25rem] border-[8px] border-slate-800 bg-slate-800 shadow-2xl sm:w-[300px]">
      <div className="absolute left-1/2 top-0 h-5 w-28 -translate-x-1/2 rounded-b-xl bg-slate-800" />
      <div className="flex h-[560px] flex-col overflow-hidden rounded-[1.6rem] bg-[#e9eef1]">
        ...
        <div className="flex flex-1 flex-col gap-3 overflow-hidden px-3 py-4">
          <div className="max-w-[85%] rounded-2xl rounded-tl-sm bg-white px-3 py-2 text-[11px] text-neutral-600 shadow-sm">
            คุณสมชายยื่นคำขอลาใหม่ รอการพิจารณาจากคุณ
          </div>

          <div className="w-[92%] overflow-hidden rounded-2xl bg-white shadow-md">
            <div className="border-b border-neutral-100 bg-line-700 px-4 py-3">
              <p className="text-xs font-semibold text-white">คำขอลาใหม่ 🗓️</p>
            </div>
            <div className="space-y-1.5 px-4 py-3">
              <p className="text-[11px] text-neutral-500">
                พนักงาน: <span className="font-medium text-neutral-800">สมชาย ใจดี</span>
              </p>
              <p className="text-[11px] text-neutral-500">
                ประเภท: <span className="font-medium text-neutral-800">ลาป่วย (เต็มวัน)</span>
              </p>
              <p className="text-[11px] text-neutral-500">
                วันที่: <span className="font-medium text-neutral-800">12–13 ส.ค. 2569</span>
              </p>
              <span className="mt-1 inline-flex items-center rounded-full bg-amber-50 px-2 py-0.5 text-[10px] font-medium text-amber-700">
                รออนุมัติ
              </span>
            </div>
            <div className="grid grid-cols-2 divide-x divide-neutral-100 border-t border-neutral-100 text-xs font-medium">
          ...
          <div className="ml-auto max-w-[80%] rounded-2xl rounded-tr-sm bg-line-600 px-3 py-2 text-[11px] text-white shadow-sm">
